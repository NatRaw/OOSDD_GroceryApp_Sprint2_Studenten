...
namespace Grocery.App.ViewModels
{
    ...
    public partial class GroceryListItemsViewModel : BaseViewModel
    {
        ...
        private void GetAvailableProducts()
        {
            ...
            var itemsOnList = MyGroceryListItems.Select(item => item.ProductId).ToHashSet();
            ...
            foreach (var product in allProducts)
            {
                ...
                if (itemsOnList.Contains(product.Id)) continue;
        ...
        public void AddProduct(Product product)
        {
            ...
            var newProduct = new GroceryListItem(0, GroceryList.Id, product.Id, 1);

            //Voeg het GroceryListItem toe aan de dataset middels de _groceryListItemsService
            _groceryListItemsService.Add(newProduct);
